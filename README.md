...
| **[HealthIA](https://github.com/FransuaLeonSanchez/HealthIA-AIHackathon)** | Bilingual multi-agent health workflows connected to wearable and IoT data. | React, FastAPI, OpenAI, Python, AWS S3 | [Live app](https://healthia-ai.vercel.app)<br>[Repo](https://github.com/FransuaLeonSanchez/HealthIA-AIHackathon) |
